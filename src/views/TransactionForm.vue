    ...
    <PageLayout>
        ...
        <main class="p-4 space-y-6">
            ...
            <div class="space-y-4 rounded-sm bg-white p-4 shadow-sm">
                ...
                <div class="divide-y divide-gray-100">
                    <ProductLineItem v-for="(p, index) in form.products"
                                     :key="p.id"
                                     :model-value="p"
                    ...
                    <div class="pt-2 text-center">
                        <button @click="addProduct"
                                class="w-full text-sm font-medium text-indigo-600 hover:text-indigo-700">
                            + Add Item
                        </button>
                    </div>
                </div>
        ...
        <Modal :show="showProductModal"
            ...
            <div class="space-y-4 max-h-[70vh] overflow-y-auto">
                <BaseInput v-model="newProductName"
                           label="Product Name"
                           placeholder="e.g. Milk"
                           required
                           autoFocus />

                <BaseInput v-model="newProductRate"
                           type="number"
                           label="Rate"
                           required />

                <SearchableSelect v-model="newProductQuantityType"
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <BaseButton variant="ghost"
                                @click="showProductModal = false">Cancel</BaseButton>
        ...
        <Modal :show="showPaymentModeModal"
               title="Add New Payment Mode"
               @close="showPaymentModeModal = false">
            <div class="space-y-4">
                <BaseInput v-model="newPaymentModeName"
                           label="Payment Mode Name"
                           placeholder="e.g. Cash, Bank Transfer"
                           required
                           autoFocus />

                <BaseInput v-model="newPaymentModeDescription"
                           label="Description"
                           placeholder="Optional" />

                <div class="flex justify-end gap-3 mt-6">
                    <BaseButton variant="ghost"
                                @click="showPaymentModeModal = false">Cancel</BaseButton>
            ...
            <div class="space-y-4">
                ...
                <div class="flex justify-end gap-3 mt-6">
                    ...
                    <BaseButton variant="danger"
                                @click="deleteTransaction">Delete Transaction</BaseButton>
                </div>
            </div>
        </Modal>
    </PageLayout>
