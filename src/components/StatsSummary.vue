...
<template>
  <div class="space-y-3">
    <div class="grid grid-cols-2 gap-3">
        ...
        <div v-if="stats.openingBalance !== undefined" class="rounded-2xl bg-gray-50 p-3 text-center ring-1 ring-gray-200">
        ...
        <div v-if="stats.closingBalance !== undefined" class="rounded-2xl bg-blue-50 p-3 text-center ring-1 ring-blue-200">
