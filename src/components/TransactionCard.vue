    ...
    <div class="flex items-center justify-between mb-3">
      ...
      <div class="text-right">
        <div class="text-sm text-gray-600">
          ...
          <span v-if="discount > 0" class="text-green-600"> - {{ formatCurrency(discount) }}</span>
          <span v-if="charge > 0" class="text-red-600"> + {{ formatCurrency(charge) }}</span>
          <span
            v-if="productsTotal !== transaction.amount"
