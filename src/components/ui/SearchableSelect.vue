  ...
  <div class="flex flex-col gap-1.5" ref="containerRef">
    ...
    <div class="relative">
      ...
      <div 
        @click="open"
        :class="[
          'w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-2.5 text-left transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500',
      ...
      >
        ...
        <div class="p-2 border-b border-gray-100">
          <input
            ...
            v-model="searchQuery"
            type="text"
            class="w-full rounded-lg bg-gray-50 px-3 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
            placeholder="Search..."
          />
        </div>
