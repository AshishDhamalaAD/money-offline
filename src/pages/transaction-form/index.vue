...
<template>
  <PageLayout>
    ...
    <!-- Add Category Modal -->
    <BaseModal :show="showCategoryModal" title="Add New Category" z-index="z-[60]" @close="showCategoryModal = false">
      <div class="space-y-4">
    ...
    <BaseModal :show="showPaymentModeModal" title="Add New Payment Mode" @close="showPaymentModeModal = false">
      <div class="space-y-4">
        <BaseInput
